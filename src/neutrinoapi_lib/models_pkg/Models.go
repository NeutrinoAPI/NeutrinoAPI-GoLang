...
type HLRLookupResponse struct {
    ...
    Mnc                      string          `json:"mnc" form:"mnc"` //The mobile MNC number
    NumberType               string          `json:"numberType" form:"numberType"` //The number type, possible values are:<br/><ul><li>mobile</li><li>fixed-line</li><li>premium-rate</li><li>toll-free</li><li>voip</li><li>unknown</li></ul>
    ...
    Imsi                     string          `json:"imsi" form:"imsi"` //The mobile IMSI number
    Mcc                      string          `json:"mcc" form:"mcc"` //The mobile MCC number
    ...
    Msin                     string          `json:"msin" form:"msin"` //The mobile MSIN number
...
type PhoneValidateResponse struct {
    ...
    IsMobile                 bool            `json:"isMobile" form:"isMobile"` //True if this is a mobile number (only true with 100% certainty, if the number type is unknown this value will be false)
    Type                     string          `json:"type" form:"type"` //The predicted number type.<br/>Note: type detection is not possible in some countries which have no predictable prefix pattern (you can use the HLR Lookup API in these cases)<br/> Possible values are:<br/><ul><li>mobile</li><li>fixed-line</li><li>premium-rate</li><li>toll-free</li><li>voip</li><li>unknown (use HLR lookup instead)</li></ul>
...
type BrowserBotResponse struct {
    ...
    Elements          []string        `json:"elements" form:"elements"` //Array containing all the elements matching the supplied selector.<br/>Each element object will contain the text content, HTML content and all current element attributes
...
type UserAgentInfoResponse struct {
    ...
    Type                   string          `json:"type" form:"type"` //The user agent type, possible values are:<br/><ul><li>desktop-browser</li><li>mobile-browser</li><li>email-client</li><li>feed-reader</li><li>software-library</li><li>media-player (includes smart TVs)</li><li>robot</li><li>unknown</li></ul>
